  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-[#e0e0e0] font-mono">
      ...
      {tab === 'wheel' && (
        <div>
          <div className="p-3.5 border-b border-white/[0.03]">
            <div className="text-[9px] text-white/25 tracking-widest mb-2">FILTER BY COLOR</div>
          ...
          {activeColor && (
            <div className="p-3.5 bg-white/[0.015] border-b border-white/[0.03]">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="font-serif text-[17px] text-white">{COLORS[activeColor].name}</span>
                <span className="text-[10px] text-white/25 ml-auto">{colorMatches.length} emotions</span>
              </div>
              ...
              <div className="flex flex-wrap gap-1 mt-2.5">
                {colorMatches.map((e) => (
                  <button
                    ...
                    className="px-2 py-1 text-[10px] font-mono bg-white/[0.04] text-white/60 border border-white/[0.07] rounded cursor-pointer hover:bg-white/[0.08] transition-colors"
                  >
          ...
          {selected && (
            <div ref={detailRef} className="p-4 border-t border-white/5 bg-white/[0.02]">
              <div className="flex justify-between items-baseline">
                <h2 className="font-serif text-[22px] font-normal text-white m-0">{selected.name}</h2>
              ...
              <p className="text-[12px] leading-relaxed text-white/50 mt-3 m-0">{selected.insight}</p>
      ...
      {tab === 'language' && (
        <div>
          <div className="p-3.5 border-b border-white/[0.03]">
            <div className="text-[9px] text-white/25 tracking-widest mb-2">SELECT A COLOR</div>
      ...
      {tab === 'psych' && (
        <div>
          ...
          <div className="px-5 pb-5">
            <div className="p-3.5 bg-white/[0.02] rounded border-l-2 border-white/[0.08]">
      ...
      {tab === 'fiction' && (() => {
        ...
        return (
          <div>
            <div className="p-3.5 border-b border-white/[0.03]">
              <div className="text-[9px] text-white/25 tracking-widest mb-2">SELECT A UNIVERSE</div>
      ...
      <footer className="p-4 border-t border-white/[0.03] text-[9px] text-white/15 tracking-wide">
